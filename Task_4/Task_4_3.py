...
else: print("Элементы, которые входят в оба множества: ",str(set_1.intersection(set_2))[1:-1])

if (len(set_1.difference(set_2)) == 0):
    print("Все элементы первого множества входят во второе")
else: print("Элементы первого множества,\
...
else: print("Элементы второго множества,\
...
else: print("Не совпадающие элементы множеств: ",\
